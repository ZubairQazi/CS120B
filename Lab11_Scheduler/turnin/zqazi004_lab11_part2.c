...
unsigned char keypad_led_output = 0x00;
unsigned char pause = 0;
unsigned char x = '\0';

unsigned char count = 0;
unsigned char*  legend_output = 0;
...
enum displayLegendStates { display1, display2, display3, end};

int displayLegendSMTick(int state) {
    ...
    switch (state) {
        ...
        default: state = display1; break;
    }

    switch (state) {
        case display1:
            legend_output = "CS120B is Legend... ";
            LCD_DisplayString(1, "CS120B is Legend... ");
            count++;
            break;

        case display2:
            legend_output = "...wait for it...";
...
int main(void) {
    ...
    task1.TickFct = &displayLegendSMTick;
/*
    task2.state = start;
    task2.period = 500;
